...
# SPECIFICATION: This program creates a menu to interact with a MongoDB database. The user can create, update, delete documents, and output the inverted index ordered by term.
